...
export default function Portfolio() {
  ...
  const expertise = [
    {
      icon: LineChart,
      title: "Time-Series Forecasting & ALM",
      desc: "SARIMAX and cohort-based forecasting for mortgage prepayments, originations, and credit card LTV/PCL — built to support balance-sheet planning and Treasury decisions.",
    },
    {
      icon: TrendingUp,
      title: "Pricing & Segmentation",
      desc: "Price-sensitivity segmentation, elasticity & optimization (LP, MIP, non-linear), and tree-based panel models that translate directly into margin and revenue.",
    },
    {
      icon: Database,
      title: "Causal Inference & Experimentation",
      desc: "A/B testing and causal inference frameworks used to measure incremental ROI and isolate the true impact of pricing and marketing decisions.",
    },
    {
      icon: Cpu,
      title: "GenAI & Agentic AI",
      desc: "Multi-agent frameworks built on cloud platforms, Ollama, and LangChain — taken from proof-of-concept toward production use cases in customer primacy and personalization.",
    },
  ];
  ...
  const projects = [
    {
      ...
      summary: "Led and co-developed a tree-based panel model identifying high price-sensitive, high-LTV clients, feeding into a redesigned pricing optimization model.",
      details: [
        "Built customer price-sensitivity segmentation using tree-based panel modelling",
        "Identified high price-sensitive yet high-value (LTV) client segments",
        "Redesigned pricing optimization model to incorporate new sensitivity segments",
        "Delivered $4.6M in incremental value with a 6% margin improvement and no volume change",
      ],
    },
    {
      title: "Mortgage Volume Forecaster",
      tag: "Time Series / ALM",
      summary: "Built a SARIMAX-based forecasting model to predict mortgage prepayments and payoffs six months out, supporting balance-sheet planning and ALM analytics.",
      details: [
        "Combined SARIMAX, model selection, and cohort/time-series techniques",
        "Achieved 93% accuracy over a 6-month forecast horizon",
        "Directly supported balance-sheet planning and ALM analytics decisions",
        "Extended the underlying forecasting framework to credit card LTV and PCL forecasting for P&L planning",
      ],
    },
    {
      title: "Flow-of-Funds Behavioural Analytics",
      tag: "Deposits / FHSA",
      summary: "Pioneered a behavioural analytics framework separating internal and external money movement across FHSA and deposit products.",
      details: [
        "Designed flow-of-funds analytics distinguishing internal vs. external money movement",
        "Identified behavioural risk drivers, attrition signals, and new-money patterns",
        "Applied framework specifically to FHSA and broader deposit products",
      ],
    },
    {
      title: "Multi-Agent PoC for Customer Primacy",
      tag: "Agentic AI",
      summary: "Coordinated and led a cross-functional team to design a multi-agent proof-of-concept aimed at enhancing customer primacy and deposit growth.",
      details: [
        "Led a cross-functional team through ambiguity to scope and build the PoC",
        "Designed multi-agent architecture targeting customer primacy and deposit growth",
        "Placed 3rd in Scotiabank's Agentic AI hackathon with this work",
      ],
    },
    {
      title: "TMLS Conference Copilot Agent",
      tag: "Agentic AI",
      summary: "Mobilized Scotiabank co-attendees at the Toronto Machine Learning Summit to build a Microsoft 365 Copilot agent delivering personalized, context-aware conference summaries.",
      details: [
        "Mobilized cross-functional Scotiabank co-attendees at TMLS to scope and build the solution",
        "Built a Microsoft 365 Copilot agent to synthesize multi-attendee conference notes",
        "Delivered personalized, context-aware summaries and key learnings tailored to each attendee",
        "Extended agentic AI from internal hackathon PoC into a live, real-world conference use case",
      ],
    },
    {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
          ...
          <div className="md:hidden flex flex-col bg-zinc-950 border-t border-zinc-800/60 px-6 py-4 gap-4">
            {navLinks.map((l) => (
              <button
                key={l.id}
                onClick={() => scrollTo(l.id)}
                className="text-left text-sm text-zinc-300 hover:text-blue-400"
              >
                {l.label}
              </button>
            ))}
      ...
      <section id="hero" className="relative pt-40 pb-28 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative">
          <p className="text-blue-400 text-sm font-medium tracking-widest uppercase mb-4">
            Ph.D. | AI/ML Builder &amp; Enabler
          </p>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight tracking-tight text-white mb-6">
            Priya Alagarsamy, Ph.D.
          </h1>
          <h2 className="text-xl md:text-2xl text-zinc-300 font-light mb-8 max-w-2xl">
            I build — and enable others to build — repeatable analytical capabilities that
            translate into scalable financial results.
          </h2>
          <p className="text-zinc-400 max-w-2xl mb-10 leading-relaxed">
            10+ years of experience, including 3 years leading teams. $18M in annual enterprise
            value delivered across GIC pricing and marketing through production-grade AI/ML
            models. Ph.D. in Finance and Business Economics.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <button
              ...
              className="border border-zinc-700 hover:border-blue-400 hover:text-blue-400 font-medium px-6 py-3 rounded-lg flex items-center gap-2 transition-colors"
            >
      ...
      <section id="about" className="py-24 px-6 border-t border-zinc-800/60">
        <div className="max-w-4xl mx-auto">
          ...
          <h3 className="text-3xl font-bold text-white mb-8">
            From systems engineering to academic research to applied AI/ML
          </h3>
          <div className="text-zinc-300 leading-relaxed space-y-5 text-lg">
            <p>
              I lead the design, build, and operationalization of AI/ML models — pricing
              optimization, time-series forecasting, propensity modelling, and agentic AI — that
              translate strategic priorities into production-grade, repeatable analytics products.
            </p>
            <p>
              At Scotiabank, I've led the redesign of GIC pricing optimization, built mortgage
              and credit card forecasting frameworks used in balance-sheet and P&L planning, and
              led a cross-functional team to a 3rd place finish in the bank's Agentic AI
              hackathon. My path — from systems engineering, through a Ph.D. in Finance at the
              University of Washington, into industry AI/ML — has repeatedly forced me to unlearn,
              relearn, and rebuild frameworks, and it's shaped how I approach ambiguity.
            </p>
            <p>
              I'm currently focused on Director-level analytics leadership roles, with a parallel
              build toward fractional advisory work for non-profit organizations that need senior
              quantitative judgment without a full-time hire.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {expertise.map((e) => (
              <div
                key={e.title}
                className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-6 hover:border-blue-500/50 transition-colors"
              >
          ...
          <div className="mt-10 flex flex-wrap gap-2">
            {["Python", "SQL", "SAS", "GCP / BigQuery", "PySpark", "TensorFlow", "LangChain", "Ollama", "Optimization (LP/MIP)", "Causal Inference"].map((t) => (
              <span key={t} className="text-xs text-zinc-400 bg-zinc-900/80 border border-zinc-800 px-3 py-1.5 rounded-full">
                {t}
              </span>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((p, i) => (
              <button
                ...
                className="text-left bg-zinc-900/60 border border-zinc-800 rounded-xl p-6 hover:border-blue-500/50 transition-colors group"
              >
                ...
                <span className="text-sm text-zinc-500 flex items-center gap-1 group-hover:text-blue-400 transition-colors">
      ...
      {activeProject !== null && (
        ...
        >
          <div
            className="bg-zinc-900 border border-zinc-700 rounded-2xl max-w-lg w-full p-8 relative"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-6">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Six predictive models mentored into production, $1M+ in retention value per wave.
                I hand over ownership deliberately, once trust is earned.
              </p>
            </div>
            <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-6">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Every model I build ties back to a decision that matters — and to a team that
                feels safe enough to question it.
              </p>
            </div>
            <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-6">
              ...
              <p className="text-zinc-400 text-sm leading-relaxed">
                Scaling a high-performing analytics team with succession in mind, and contributing
                to published methodology in financial analytics. Currently completing CFA Level III.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="blog" className="py-24 px-6 border-t border-zinc-800/60">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-zinc-400 mb-12 max-w-2xl">
            Writing on ML system design, pricing strategy, and the realities of building a senior
            analytics career.
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            {posts.map((post) => (
              <div
                key={post.title}
                className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-6 flex flex-col hover:border-blue-500/50 transition-colors"
              >
                <span className="inline-block text-xs font-medium text-blue-300 bg-blue-500/10 px-3 py-1 rounded-full mb-4 w-fit">
                  {post.tag}
                </span>
          ...
          <p className="text-zinc-500 text-xs mt-8 italic">
            More posts coming soon — this section is ready for your published articles.
          </p>
        </div>
      </section>
      ...
      <section id="resume" className="py-24 px-6 border-t border-zinc-800/60 bg-zinc-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-zinc-400 mb-3 max-w-xl mx-auto">
            Ph.D., Finance &amp; Business Economics — University of Washington (Foster School of Business)
          </p>
          <p className="text-zinc-500 text-sm mb-10 max-w-xl mx-auto">
            Senior Manager / Senior Data Scientist, Pricing &amp; Advanced Analytics Modeling — Scotiabank
          </p>
          <button className="bg-blue-500 hover:bg-blue-400 text-white font-medium px-8 py-3 rounded-lg inline-flex items-center gap-2 transition-colors">
      ...
      <section id="contact" className="py-24 px-6 border-t border-zinc-800/60">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-zinc-400 mb-10">
            Open to Director-level analytics leadership roles and select fractional or consulting engagements for non-profit causes.
          </p>
          ...
          <p className="text-zinc-600 text-xs mt-2">GitHub repos are actively being cleaned up and updated.</p>
        </div>
      </section>
